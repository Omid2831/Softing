...
import '../../../styles/highlight-card.css'
        ...
        <section className="service grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 w-full px-3 py-5 gap-3 sm:px-5 sm:py-8 sm:gap-4 md:px-7 md:py-10 md:gap-5">
            {data.map((item) => {
                ...
                return (
                    <Card
                        key={item.id}
                        className="highlight-card rounded-xl shadow-md px-3 py-6 space-y-2 sm:px-5 sm:py-8 sm:space-y-3 md:px-7 md:py-10 md:space-y-4 bg-white flex flex-col items-center text-center"
                    >
                        {Icon && (
